...
console.log("setelah menggunakan method indexOf  maka akan menunjukan index ke berapa element yang di sebutkan " +"dalam hal ini banana adalah index ke: "+ index)

// 6. method lastIndexOf mengembalikan nilai index dalam terakhir/terbesar di sebuah array
const index1=["1","2","3","4","5"]
console.log(index1)
console.log(index1.lastIndexOf("15"))
...
//7. method every() mengembalikan nilai true jika semua kondisi di method every terpenuhi
    const kondisi =(kondisiTerpenuhi) => kondisiTerpenuhi < 50      

    const nilai =[29,15,26,"30","25"]
